...
export const OTPForm = ({ refreshTrigger, mobile, onBack, formattedTime, timeLeft, onResend,SubmitOtpForm,loadingotp,errorApi,verifyResData }) => {
          ...
          <View>
            ...
            >
              ...
              <View>
                ...
                >
                  Verify OTP
                  {loadingotp && <Loader size={15} style={{ paddingTop: 7, paddingLeft: 5 }} />}
                </Button>
